...
const LeftSide = () => {
  const [text] = useTypewriter({
    words: ["Full Stack Developer.", "Problem Solver.", "Cloud Enthusiast.", "Team Player."],
    loop: true,
    typeSpeed: 20,
    deleteSpeed: 10,
    delaySpeed: 2000,
      ...
      <div className="w-full flex flex-col gap-10 px-5 pt-5 xl:px-0">
        <div className="flex flex-col gap-5">
          <h1 className="text-5xl font-bold text-white">
            Hi, I&apos;m{" "}
            <span className="text-designColor capitalize">Yashvi Chauhan</span>
          </h1>
...
const profiles = [
  {
    href: "https://www.linkedin.com/in/yashvi-chauhan-97096213a/",
    icon: <FaLinkedinIn />,
  },
  {
    href: "https://github.com/yashvichauhan",
    icon: <FaGithub />,
  },
  {
    href: "https://leetcode.com/u/yashvic/",
    icon: <SiLeetcode />,
  },
  {
    href: "https://www.hackerrank.com/profile/yashvichauhan19",
    icon: <FaHackerrank />,
  }
];
